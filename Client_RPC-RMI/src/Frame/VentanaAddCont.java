...
public class VentanaAddCont extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cajaNumero = new javax.swing.JTextField(10);
        ...
        cajaNombre.addKeyListener(new KeyAdapter() {
            ...
            {if (cajaNombre.getText().length()== 49)
        ...
        cajaApellido.addKeyListener(new KeyAdapter(){
            public void keyTyped(KeyEvent e)

            {if (cajaApellido.getText().length()== 49)
    ...
    cajaEmail.addKeyListener(new KeyAdapter(){
        public void keyTyped(KeyEvent e)

        {if (cajaEmail.getText().length()== 49)
